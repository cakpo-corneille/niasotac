              ...
              <li>
                ...
                <ul className='flex gap-3'>
                  {settings?.social_links && Object.entries(settings.social_links).map(([name, url]) => {
                    ...
                    return ( 
                      <li key={name}>
                        <a href={url as string} target='_blank' rel='noopener noreferrer' className='text-muted-foreground hover:text-primary transition-colors' data-testid={`link-social-${name}`}>
