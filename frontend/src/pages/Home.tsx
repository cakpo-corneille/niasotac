              ...
              >
                <CarouselContent className="-ml-2 sm:-ml-3">
                  {featuredProducts.map((product) => (
                    <CarouselItem key={product.id} className="pl-2 sm:pl-3 basis-full sm:basis-1/2 lg:basis-1/3">
                      <div className="h-full">
                        <ProductCard product={product} showCategoryBadge={false} />
                      </div>
                    </CarouselItem>
                  ))}
                </CarouselContent>
                <CarouselPrevious className="hidden md:flex" data-testid="button-carousel-prev-featured" />
                <CarouselNext className="hidden md:flex" data-testid="button-carousel-next-featured" />
              </Carousel>
            </div>
          ) : (
              ...
              >
                <CarouselContent className="-ml-2 sm:-ml-3">
                  {newProducts.map((product) => (
                    <CarouselItem key={product.id} className="pl-2 sm:pl-3 basis-full sm:basis-1/2 lg:basis-1/4">
                      <div className="h-full">
                        <ProductCard product={product} showCategoryBadge={false} />
                      </div>
                    </CarouselItem>
                ...
                <CarouselPrevious className="hidden md:flex" data-testid="button-carousel-prev-new" />
                <CarouselNext className="hidden md:flex" data-testid="button-carousel-next-new" />
              </Carousel>
            </div>
          ) : (
            <div className="text-center py-12 text-muted-foreground">
