...
| `is_in_stock` | Boolean | Produit disponible |
...
# Filtrer par stock (disponible ou non)
GET /api/v1/products/?is_in_stock=true
...
GET /api/v1/products/?category_slug=smartphones&brand=Samsung&min_price=300&max_price=800&is_in_stock=true&has_discount=true&ordering=-featured_score
```
...
- [ ] Afficher la disponibilité (is_in_stock)
      ...
      <aside className="filters">
        ...
        <label>
          <input 
            ...
            onChange={e => updateFilter('is_in_stock', e.target.checked)}
          />
          En stock uniquement
        </label>
