...
class Product(models.Model):
    ...
    characteristics = models.TextField(verbose_name="Caractéristiques", blank=True, default="")
    ...
    is_in_stock = models.BooleanField(
        ...
        db_index=True,
        help_text="Indique si le produit est disponible à la vente"
    )
    ...
    def get_final_price(self):
        """Retourne le prix final après promotions"""
    ...
    def get_whatsapp_link(self):
        """Retourne le lien WhatsApp pour le produit"""
        try:
    ...
    def whatsapp_link(self):
        """Propriété pour accès direct au lien WhatsApp"""
